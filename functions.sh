...
function instrumentForKiekerBytebuddy {
	...
	echo 'export KIEKER_SIGNATURES_INCLUDE="tools.descartes.teastore.[A-z]*" >> /usr/local/tomcat/bin/setenv.sh' >> utilities/tools.descartes.teastore.dockerbase/start.sh
